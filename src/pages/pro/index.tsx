...
export default function Index() {
  return (
    <Layout spec={pageSpec}>
      ...
      >
        <Block title="Block 2" rounded shadow>
        ...
        <Block title="Block 3" shadow>
          This problem is occurred when you have tried to rehydrate you react
          app. Generated react app rehydrate with generated markup at that time
          it show empty space between jsx tags.
        </Block>
      </div>

      <Text mb={15}>
        Thank you! I wasted 2 days with this problem, and none of the solutions
        were good.
      </Text>
      <Text mb={25}>
